  ...
  if (error && !data) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center gap-4">
        ...
        <p className="text-lg font-medium">Could not load wind data</p>
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/50 bg-background/90 backdrop-blur-md">
      <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-sm font-semibold leading-tight">IJmuiden Wind Intelligence</h1>
          <p className="text-[11px] text-muted-foreground">RWS live · Multi-model forecast</p>
        </div>
      </div>
    </header>
  );
